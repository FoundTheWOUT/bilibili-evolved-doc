...
1.  <Link href="/docs/user/install">[安装]()</Link>
2.  <Link href="/docs/user/settings">[设置]()</Link>
...
欢迎参考<Link href="/docs/developer">[代码贡献指南]()</Link>来为项目添砖加瓦~
...
**或者也可以考虑<Link href="/docs/user/donate">[捐助]()</Link>支持一下哦(｀・ω・´)**
